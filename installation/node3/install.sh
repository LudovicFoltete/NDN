...
ndnsec-key-gen /ndn/upec/%C1.Router/router3 > router3.key

#generate the certificate for the router key
ndnsec-cert-dump -i /ndn/upec/%C1.Router/router3 > router3.cert

#install the router certificate
ndnsec-cert-install -f router3.cert
