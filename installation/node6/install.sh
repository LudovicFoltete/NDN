...
ndnsec-key-gen /ndn/upec/%C1.Router/router6 > router6.key

#generate the certificate for the router key
ndnsec-cert-dump -i /ndn/upec/%C1.Router/router6 > router6.cert

#install the router certificate
ndnsec-cert-install -f router6.cert
